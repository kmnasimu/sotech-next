                        ...
                        <div className="blog-details__left">
                            ...
                            <div className="blog-details__content">
                                <ul className="list-unstyled blog-details__meta">
                                    ...
                                    <li><Link href="/news-details"><i className="fas fa-comments" /> 02 omments</Link></li>
                                </ul>
                        ...
                        <div className="sidebar">
                                ...
                                <ul className="sidebar__post-list list-unstyled">
                                    <li>
                                        ...
                                        <div className="sidebar__post-content">
                                            <h3><span className="sidebar__post-content-meta"><i className="fas fa-user-circle" />Admin</span><Link href="/news-details">Top crypto exchange influencers</Link>
                                            </h3>
                                        </div>
                                    </li>
                                    <li>
                                        ...
                                        <div className="sidebar__post-content">
                                            <h3><span className="sidebar__post-content-meta"><i className="fas fa-user-circle" />Admin</span><Link href="/news-details">Necessity may give us best virtual court</Link></h3>
                                        </div>
                                    </li>
                                    <li>
                                        <div className="sidebar__post-image"> <img src="images/resource/news-3.jpg" alt /> </div>
                                        <div className="sidebar__post-content">
                                            <h3><span className="sidebar__post-content-meta"><i className="fas fa-user-circle" />Admin</span><Link href="/news-details">You should know about business plan</Link></h3>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                            <div className="sidebar__single sidebar__category">
                                ...
                                <ul className="sidebar__category-list list-unstyled">
                                    <li><Link href="/news-details">Business<span className="icon-right-arrow" /></Link></li>
                                    <li className="active"><Link href="/news-details">Digital Agency<span className="icon-right-arrow" /></Link></li>
                                    <li><Link href="/news-details">Introductions<span className="icon-right-arrow" /></Link></li>
                                    <li><Link href="/news-details">New Technologies<span className="icon-right-arrow" /></Link></li>
                                    <li><Link href="/news-details">Parallax Effects<span className="icon-right-arrow" /></Link></li>
                                    <li><Link href="/news-details">Web Development<span className="icon-right-arrow" /></Link></li>
                                </ul>
                            </div>
