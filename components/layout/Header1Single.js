...
const Header1Single = ({ handleOpen, handleRemove, searchToggle, handleToggle, scroll }) => {

    return (
        <>

        <header id="home" className={`main-header header-style-six ${scroll ? "fixed-header" : ""} ${searchToggle ? "moblie-search-active" : ""}`}>
