...
const Header2Single = ({ handleOpen, handleRemove, searchToggle, handleToggle, scroll }) => {
    ...
    return (
        ...
        <header id="home" className={`main-header header-style-two style-transparent ${scroll ? "fixed-header" : ""} ${searchToggle ? "moblie-search-active" : ""}`}>
