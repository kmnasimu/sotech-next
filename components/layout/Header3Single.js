...
const Header3Single = ({ handleOpen, handleRemove, searchToggle, handleToggle, scroll }) => {

    return (
        <>

            <header id="home" className={`main-header header-style-two ${scroll ? "fixed-header" : ""} ${searchToggle ? "moblie-search-active" : ""}`}>
